...
import { getPublicInsight } from "@/features/cms/public-content";
...
export async function generateMetadata({ params }: InsightPageProps): Promise<Metadata> {
  ...
  return insight
    ? createMetadata({
        ...
        description: insight.seoDescription ?? insight.dek,
